      ...
      <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden bg-background pt-20 border-b border-border">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-10">
          ...
          <ScrollReveal delay={150}>
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-serif text-foreground leading-[1.1] tracking-tight mb-8">
              {dict.hero.title}
            </h1>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <ScrollReveal delay={0}>
              <div className="text-center p-8 bg-card border border-border">
                ...
                <h3 className="text-lg font-medium mb-3">{dict.about.experience}</h3>
            ...
            <ScrollReveal delay={150}>
              <div className="text-center p-8 bg-card border border-border">
                ...
                <h3 className="text-lg font-medium mb-3">{dict.about.properties}</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <ScrollReveal delay={300}>
              <div className="text-center p-8 bg-card border border-border">
                ...
                <h3 className="text-lg font-medium mb-3">{dict.about.service}</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
