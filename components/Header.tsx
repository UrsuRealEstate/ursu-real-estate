...
export function Header({ lang }: { lang: Locale }) {
  ...
  if (!dict) return <header className="h-20 w-full fixed top-0 z-50 transition-all duration-300 bg-background/80 backdrop-blur-md border-b" />
  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 bg-primary text-primary-foreground ${isScrolled ? 'shadow-md py-3' : 'py-5'
        }`}
    >
